...
{
    public partial class frmSettingData : frmBaseWindow
    {
        #region Member
        ...
        #endregion
        #region   Constructor
        public frmSettingData()
        {
            InitializeComponent();
            sqlitesrv.doinitTableCPSMaster();
        ...
        private void doAddHeaderDataFileMap(Dictionary<string, string>? dicHeader)
        {
            ...
            if (dicHeader != null)
            {
                ...
                cmb_CardNo2.Items.Clear();
                cmb_CardNo2.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_JudgmentAmnt2.Items.Clear(); //ยอดพิพากษา
                cmb_JudgmentAmnt2.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_PrincipleAmnt2.Items.Clear(); //ต้นเงิน
                cmb_PrincipleAmnt2.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_PayAfterJudgAmt2.Items.Clear();//ชำระหลังพิพากษา
                cmb_PayAfterJudgAmt2.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_DeptAmnt2.Items.Clear();//ภาระหนี้ปัจจุบัน
                cmb_DeptAmnt2.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_LastPayDate2.Items.Clear();//ชำระครั้งล่าสุด
                cmb_LastPayDate2.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_CardNo3.Items.Clear();
                cmb_CardNo3.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_JudgmentAmnt3.Items.Clear(); //ยอดพิพากษา
                cmb_JudgmentAmnt3.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_PrincipleAmnt3.Items.Clear(); //ต้นเงิน
                cmb_PrincipleAmnt3.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_PayAfterJudgAmt3.Items.Clear();//ชำระหลังพิพากษา
                cmb_PayAfterJudgAmt3.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_DeptAmnt3.Items.Clear();//ภาระหนี้ปัจจุบัน
                cmb_DeptAmnt3.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_LastPayDate3.Items.Clear();//ชำระครั้งล่าสุด
                cmb_LastPayDate3.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_CardNo4.Items.Clear();
                cmb_CardNo4.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_JudgmentAmnt4.Items.Clear(); //ยอดพิพากษา
                cmb_JudgmentAmnt4.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_PrincipleAmnt4.Items.Clear(); //ต้นเงิน
                cmb_PrincipleAmnt4.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_PayAfterJudgAmt4.Items.Clear();//ชำระหลังพิพากษา
                cmb_PayAfterJudgAmt4.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_DeptAmnt4.Items.Clear();//ภาระหนี้ปัจจุบัน
                cmb_DeptAmnt4.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_LastPayDate4.Items.Clear();//ชำระครั้งล่าสุด
                cmb_LastPayDate4.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_CardNo5.Items.Clear();
                cmb_CardNo5.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_JudgmentAmnt5.Items.Clear(); //ยอดพิพากษา
                cmb_JudgmentAmnt5.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_PrincipleAmnt5.Items.Clear(); //ต้นเงิน
                cmb_PrincipleAmnt5.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_PayAfterJudgAmt5.Items.Clear();//ชำระหลังพิพากษา
                cmb_PayAfterJudgAmt5.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_DeptAmnt5.Items.Clear();//ภาระหนี้ปัจจุบัน
                cmb_DeptAmnt5.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_LastPayDate5.Items.Clear();//ชำระครั้งล่าสุด
                cmb_LastPayDate5.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_CardNo6.Items.Clear();
                cmb_CardNo6.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_JudgmentAmnt6.Items.Clear(); //ยอดพิพากษา
                cmb_JudgmentAmnt6.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_PrincipleAmnt6.Items.Clear(); //ต้นเงิน
                cmb_PrincipleAmnt6.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_PayAfterJudgAmt6.Items.Clear();//ชำระหลังพิพากษา
                cmb_PayAfterJudgAmt6.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_DeptAmnt6.Items.Clear();//ภาระหนี้ปัจจุบัน
                cmb_DeptAmnt6.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_LastPayDate6.Items.Clear();//ชำระครั้งล่าสุด
                cmb_LastPayDate6.Items.AddRange(dicHeader.Keys.ToArray());
        ...
        private void doAddHeaderDataCustomMap(Dictionary<string, string>? dicHeader)
        {
            if (dicHeader != null)
            {
                ...
                cmb_custom_Installment6Amnt1.Items.Clear();
                cmb_custom_Installment6Amnt1.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_custom_Installment6Amnt2.Items.Clear();
                cmb_custom_Installment6Amnt2.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_custom_Installment6Amnt3.Items.Clear();
                cmb_custom_Installment6Amnt3.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_custom_Installment6Amnt4.Items.Clear();
                cmb_custom_Installment6Amnt4.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_custom_Installment6Amnt5.Items.Clear();
                cmb_custom_Installment6Amnt5.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_custom_Installment6Amnt6.Items.Clear();
                cmb_custom_Installment6Amnt6.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_custom_Installment12Amnt1.Items.Clear();
                cmb_custom_Installment12Amnt1.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_custom_Installment12Amnt2.Items.Clear();
                cmb_custom_Installment12Amnt2.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_custom_Installment12Amnt3.Items.Clear();
                cmb_custom_Installment12Amnt3.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_custom_Installment12Amnt4.Items.Clear();
                cmb_custom_Installment12Amnt4.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_custom_Installment12Amnt5.Items.Clear();
                cmb_custom_Installment12Amnt5.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_custom_Installment12Amnt6.Items.Clear();
                cmb_custom_Installment12Amnt6.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_custom_Installment24Amnt1.Items.Clear();
                cmb_custom_Installment24Amnt1.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_custom_Installment24Amnt2.Items.Clear();
                cmb_custom_Installment24Amnt2.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_custom_Installment24Amnt3.Items.Clear();
                cmb_custom_Installment24Amnt3.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_custom_Installment24Amnt4.Items.Clear();
                cmb_custom_Installment24Amnt4.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_custom_Installment24Amnt5.Items.Clear();
                cmb_custom_Installment24Amnt5.Items.AddRange(dicHeader.Keys.ToArray());

                cmb_custom_Installment24Amnt6.Items.Clear();
                cmb_custom_Installment24Amnt6.Items.AddRange(dicHeader.Keys.ToArray());
        ...
        private void doSaveDataExcelFestCustom()
        {
            ...
            if (!string.IsNullOrEmpty(pathfile))
            {
                if (File.Exists(pathfile))
                {
                    ...
                    if (datatablecustom.Rows.Count > 0)
                    {
        ...
        private void doExportDataDuplicateID()
        {
            ...
            for (int i = 0; i < dataduplicate.Count; i++)
            {
                ...
                datadup["CaseID"] = dataduplicate[i].CaseID;
                datadup["CardStatus"] = dataduplicate[i].CardStatus;
        ...
        private void btn_loaddata_excel_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(pathfile))
            {
                if (File.Exists(pathfile))
                {
                    ...
                    sqlitesrv.doInsertMasterData(dtraw, CPSMasterCtrl, chk_clear_master.Checked, this.progressBarMaster);
        ...
        private void btn_export_template_Click(object sender, EventArgs e)
        {
            ...
            string filename = "";
            string[] captionth = new string[] {"CaseID","สถานะบัตร","หมายเลขบัตร1","ยอดพิพากษาบัตร1","ต้นเงินบัตร1","ชำระหลังพิพากษาบัตร1","ภาระหนี้ปัจจุบันบัตร1","LastPayDateบัตร1","หมายเลขบัตร2","ยอดพิพากษาบัตร2","ต้นเงินบัตร2","ชำระหลังพิพากษาบัตร2","ภาระหนี้ปัจจุบันบัตร2","LastPayDateบัตร2","หมายเลขบัตร3","ยอดพิพากษาบัตร3","ต้นเงินบัตร3","ชำระหลังพิพากษาบัตร3","ภาระหนี้ปัจจุบันบัตร3","LastPayDateบัตร3",
                                              "หมายเลขบัตร4","ยอดพิพากษาบัตร4","ต้นเงินบัตร4","ชำระหลังพิพากษาบัตร4","ภาระหนี้ปัจจุบันบัตร4","LastPayDateบัตร4","หมายเลขบัตร5","ยอดพิพากษาบัตร5","ต้นเงินบัตร5","ชำระหลังพิพากษาบัตร5","ภาระหนี้ปัจจุบันบัตร5","LastPayDateบัตร5","หมายเลขบัตร6","ยอดพิพากษาบัตร6","ต้นเงินบัตร6","ชำระหลังพิพากษาบัตร6","ภาระหนี้ปัจจุบันบัตร6","LastPayDateบัตร6",
                                              "ชื่อ-สกุล (ใหม่)","เบอร์ติดต่อ(ลูกค้า)","ID","Legal Status","คดีดำ","คดีแดง","วันพิพากษา","ชื่อศาล","หมายเหตุบังคับคดี","วันที่ยึดอายัติ(ล่าสุด)","Collector","Team","เบอร์ติดต่อ" };
            string[] captioneng = new string[] {"CaseID","CardStatus","CardNo1","JudgmentAmnt1","PrincipleAmnt1","PayAfterJudgAmt1","DeptAmnt1","LastPayDate1","CardNo2","JudgmentAmnt2","PrincipleAmnt2","PayAfterJudgAmt2","DeptAmnt2","LastPayDate2","CardNo3","JudgmentAmnt3","PrincipleAmnt3","PayAfterJudgAmt3","DeptAmnt3","LastPayDate3","CardNo4",
                                                "JudgmentAmnt4","PrincipleAmnt4","PayAfterJudgAmt4","DeptAmnt4","LastPayDate4","CardNo5","JudgmentAmnt5","PrincipleAmnt5","PayAfterJudgAmt5","DeptAmnt5","LastPayDate5","CardNo6","JudgmentAmnt6","PrincipleAmnt6","PayAfterJudgAmt6","DeptAmnt6","LastPayDate6","CustomerName",
                                                "CustomerTel","CustomerID","LegalStatus","BlackNo","RedNo","JudgeDate","CourtName","LegalExecRemark","LegalExecDate","CollectorName","CollectorTeam","CollectorTel",};

            if (!string.IsNullOrEmpty(folderpath))
            {
                DataTable datatatemplate = dtService.doCreateMasterCPSDataTemplate();
        ...
        private void btn_fest_csutomtemplate_Click(object sender, EventArgs e)
        {
            ...
            string[] captioneng = new string[] {"CustomerID","CustomerName","WorkNo","LedNumber","CardNo1","AccCloseAmnt1","AccClose6Amnt1","Installment6Amnt1","AccClose12Amnt1","Installment12Amnt1","AccClose24Amnt1","Installment24Amnt1","CardNo2","AccCloseAmnt2","AccClose6Amnt2","Installment6Amnt2","AccClose12Amnt2","Installment12Amnt2"
